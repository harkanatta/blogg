...
---
Kortið á mynd 1 hér að neðan er unnið upp úr gögnum frá haffræðingnum Kai Logemann. Kai starfaði um árabil hérlendis og gerði sjávarfallalíkan sem hefur  nýst til þess að spá fyrir um rek agna í sjó kringum landið. Þetta kort er nákvæmasta straumakort af hafinu kringum Ísland sem ég veit um og þess vegna langaði mig til þess að nota það og um leið gera gögnin sem það byggir á aðgengilegri. 

Hér er hlekkur á [Github :file_folder: ](https://github.com/harkanatta/hafstraumakort) þar sem má sækja allt sem þarf til að endurgera myndina á botni þessar síðu.

![Kort af hafstraumum við Ísland frá Kai Logemann.](images/kai.png)

Til þess að trufla ekki manninn þá sótti ég töfluna yfir styrk straumanna í greinina hans [The circulation of Icelandic waters – a modelling study](https://os.copernicus.org/articles/9/931/2013/) með pakkanum [tabulizer](https://github.com/ropensci/tabulizer). 

![Skjáskot úr greininni af töflunni sem sýnir styrk og hitastig hafstrauma við Ísland.](images/kai_tafla.png)

Byrjum á að lesa inn pakkana. Ef þeir eru ekki allir á [CRAN](https://cran.r-project.org/) þá er hægt að sækja þá á github-síðu pakkasmiðanna. Þetta á t.d. við um [tabulizer](https://github.com/ropensci/tabulizer) pakkann þegar þetta er skrifað.
```
...
Svo er það að sækja straumstyrkinn og heiti straumanna úr töflunni í greininni:
...
Staðsetning straumanna er ekki gefin með GPS-punktum í greininni og leysti ég það vandamál frekar gróflega í [QGIS](https://www.qgis.org/en/site/). Ég get því miður ekki munað nákvæmlega hvernig ég gerði það og QGIS býður ekki upp á "reproducible workflow" á sama máta og R. 
...
```
Einfaldast fannst mér að gera .shp-skrá fyrir heiti straumanna í QGIS með því að gera nýtt „scratch-layer“ og finna sæmilega staðstningu fyrir heitin. Það er auðveldara en að staðsetja heitin með ggplot.
...
![Hafstraumar um Ísland. Gert með ggplot í R.](images/straumar.png)