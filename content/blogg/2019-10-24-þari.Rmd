...
Mitt starf hjá Náttúrustofu Norðurlands vestra felur í sér að skoða náttúruna og stunda rannsóknir á henni. Ástæða þess að flest verkefni náttúrustofanna eru á landi frekar en í sjó er sú að aðgengi er mjög takmarkað í sjó. Maður finnur það um leið og maður stekkur í sjóinn að þarna á maður ekki heima. Mín verkefni tengjast nær öll sjónum sem er óheppilegt af því leiti að `r anicon::nia("ég er",animate="spin",speed="slow")` `r anicon::nia("mjög",animate="wrench",speed="slow")` `r anicon::nia("sjóveikur.",animate="float",speed="slow")`

Ég frétti af [neðansjávardróna í ódýrari kantinum](https://www.sofarocean.com/products/trident) og langaði að sjá hvort hægt væri að nota hann til þess að skoða fiskiseiði í þarabreiðum. Þarabreiður eru skjól fyrir ýmsar sjávarlífverur og miðað við víðernin í hafinu eru þær heitur reitur með tilliti til líffjölbreytileika. 

Ég hef ekki neina sérþekkingu á þarabreiðum og veit því ekki hvaða rannsóknir hafa verið gerðar á þeim.
En hvernig átti ég að fá styrkfé til þess að skoða þarabreiður? Ég hafði enga sérþekkingu á þarabreiðum og gat ekki hannað áhugaverða rannsókn, sem ekki hefði verið gerð áður, á þeim sisvona. Það þurfti að finna annað sjónarhorn, forvitnin ein er ekki næg ástæða til að veita fé til athuganna. Því var gaukað að mér að hugsanlega mætti finna verkefni í tengslum við nýtingu á þara. Ef einhver dugandi maður sæi ástæðu til að sækja þara á svæðinu og jafnvel vinna eitthvað úr honum í þorpinu gæti það orðið akkur fyrir samfélagið og því ástæða fyrir [Uppbyggingasjóð Norðurlands vestra](http://www.ssnv.is/is/uppbyggingarsjodur) til að leggja til fé. 
...
```{r echo=FALSE}
knitr::include_url("https://harkanatta.github.io/3dkort")
```
